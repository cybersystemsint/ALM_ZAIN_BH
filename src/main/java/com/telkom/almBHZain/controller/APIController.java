...
import com.telkom.almBHZain.repo.DCCRepository;
import com.telkom.almBHZain.repo.dccstatusrepo;
import com.telkom.almBHZain.repo.DccLineRepo;
import com.telkom.almBHZain.repo.uplrepo;
import com.telkom.almBHZain.repo.polnrepo;
import com.telkom.almBHZain.repo.supplierrepo;
import com.telkom.almBHZain.repo.pohdrepo;
...
import com.telkom.almBHZain.model.tbScopeApprovalLevels;
...
import com.telkom.almBHZain.model.FileRecord;
import com.telkom.almBHZain.model.tb_Approval_Log;
import com.telkom.almBHZain.model.tb_PurchaseOrderUPL;
import com.telkom.almBHZain.repo.fileRecordRepo;
import com.telkom.almBHZain.repo.tbApprovalLogRepo;
import com.telkom.almBHZain.repo.tbArcApprovalRecordsRepo;
import com.telkom.almBHZain.repo.tbPurchaseOrderRepo;
import com.telkom.almBHZain.repo.tbPurchaseOrderUPLRepo;
...
import com.telkom.almBHZain.repo.tbCategoryApprovalLevelRepo;
import com.telkom.almBHZain.repo.tbSiteRepo;
import com.telkom.almBHZain.repo.tbRegionRepo;
import com.telkom.almBHZain.repo.tbItemCodeSubstituteRepo;
import com.telkom.almBHZain.repo.tbErrorMessageRepo;
import com.telkom.almBHZain.repo.tbChargeAccountRepo;
import com.telkom.almBHZain.repo.tbScopeApprovalLevelsRepo;
import com.telkom.almBHZain.repo.tbScopeRepo;
import com.telkom.almBHZain.repo.tbNodeRepo;
import com.telkom.almBHZain.repo.tbSerialNumberRepo;
import com.telkom.almBHZain.utlities.Httpcall;
                ...
                if (recordNoValidate == 0) {
                    ...
                    for (int j = 0; j < dcclineRequest.length(); j++) {
                        ...
                        if (actualItemCode.length() > 1) {
                            ...
                            List<tbItemCodeSubstitute> validateActualItemCode = itemCodeSubstituteRepo.findByRelatedItemCode(actualItemCode);
...
//                                }
                    ...
                    for (int k = 0; k < dcclineRequestItems.length(); k++) {
                        ...
                        if (UpdateActualItemCode.length() > 1) {
                            ...
                            List<tbItemCodeSubstitute> validateActualItemCode = itemCodeSubstituteRepo.findByRelatedItemCode(UpdateActualItemCode);
                            ...
                            itemCode = dcclineUpdatejsonObject.getString("itemCode");
                        }
...
//                                }
            ...
            if (!missingItemCode.isEmpty()) {
                return response("Error", "Actual Item Codes " + String.join(", ", missingItemCode) + " are not valid. Please use existing related item codes");
            }
